...
export default function CalendarAudit() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/audits")
      ...
      .then((data) => {
        ...
        localStorage.setItem("calendarEvents", JSON.stringify(eventsWithDates));
      })
      .catch((error) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const newEvent = {
      ...
      date: auditData.auditDate,
      description: auditData.description,
      backgroundColor: auditData.priority === "high" ? "#F56565" : "#4299E1",
    };
    try {
      const response = await fetch("http://localhost:5000/api/calendrier", {
        method: "POST",
        headers: {
      ...
      <div className="w-full px-4 ">
        <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
          <div className="p-6">
            ...
            <div className="green-glow-container rounded-lg p-1">
