...
export default function EditAuditModal({ show, onClose, onSubmit, formData, onChange }) {
  if (!show) return null;
      ...
      >
        <div className="modal-overlay">
          <div className="modal-content modal-container max-w-2xl">
            <div className="modal-header bg-gray-50 px-6 py-3 flex justify-between items-center border-b border-gray-300 pb-3 mb-6">
              <h3 className="text-2xl font-bold text-gray-900">Modifier l'action</h3>
            ...
            <form onSubmit={onSubmit} className="space-y-6 overflow-y-auto max-h-[75vh] px-4">
              <div className="grid grid-cols-2 gap-6">
                <div className="col-span-2 mb-4">
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Nom de l'action</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
